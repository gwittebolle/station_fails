...
export default class Level2 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON(
      "station-fails",
      "https://raw.githubusercontent.com/gwittebolle/station_fails/master/app/assets/tilemaps/json/realLevel_2.json"
    );
    this.load.image(
      "shark",
  ...
  async create() {
    ...
    SpriteFunctions.initSprite(this, 30, 450);
